 ...
 * @see org.jocean.jdmk.tasks.Task
 * @see org.jocean.jdmk.tasks.TaskServer
 *
 * @since Java DMK 5.0
 **/
...
public class DaemonTaskServer  implements TaskServer {
     ...
     * {@link org.jocean.jdmk.tasks.Task#run() task.run()}. It is provided
     ...
     * This method simply calls 
     * {@link org.jocean.jdmk.tasks.Task#cancel() task.cancel()}. 
     ...
     * to {@link #submitTask(org.jocean.jdmk.tasks.Task) submitTask()}.
     * When terminated, the object can not be started again, unless
     * {@link org.jocean.jdmk.tasks.DaemonTaskServer#reset()} is called.
     * @exception InterruptedException if cancel is interrupted.
     **/
     ...
     * {@link org.jocean.jdmk.tasks.DaemonTaskServer#terminate()}
