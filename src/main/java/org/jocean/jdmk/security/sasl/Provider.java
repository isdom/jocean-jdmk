...
package org.jocean.jdmk.security.sasl;
 ...
 * when using PLAIN:
 * <ul>
 *   <li>{@link org.jocean.jdmk.security.sasl.AuthenticateCallback}: to verify the
        ...
        AccessController.doPrivileged(new PrivilegedAction() {
		    ...
		    //
                    put("SaslServerFactory.PLAIN",
                        "org.jocean.jdmk.security.sasl.plain.ServerFactoryImpl");
                    return null;
                }
            });
    }
