 ...
 *
 * @see org.jocean.jdmk.comm.HttpsConnectorClient
 *
 */
public class HttpsConnectorServer
    ...
    public HttpsConnectorServer() {
        super(CommunicatorServer.HTTPS_TYPE,
	      org.jocean.jdmk.ServiceName.HTTPS_CONNECTOR_PORT);
    }
     ...
     * {@link org.jocean.jdmk.ServiceName#HTTPS_CONNECTOR_SERVER 
     *        org.jocean.jdmk.ServiceName.HTTPS_CONNECTOR_SERVER}.
	...
	throws Exception {
        if (name == null) {
            name = new ObjectName(org.jocean.jdmk.ServiceName.DOMAIN + ":" + 
			   org.jocean.jdmk.ServiceName.HTTPS_CONNECTOR_SERVER);
        }
