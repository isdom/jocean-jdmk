...
import org.jocean.jdmk.Enumerated;
...
class HtmlObjectPage extends HtmlPage {
	...
	String safeObjNameStr = translateNameToHtmlFormat(objNameStr);
		...
		//
			...
			try {
			    ...
			    if ( (sc != null) && (org.jocean.jdmk.Enumerated.class.isAssignableFrom(sc)) ) {
    ...
    /** 
     * Returns the Html representation of an instance of org.jocean.jdmk.Enumerated,
	...
	boolean w = attrInfo.isWritable();
        ...
        // org.jocean.jdmk.Enumerated to representable HTML format.
        //
	try {
	    Class c ;
	    if (result != null) {
...
//             if (logger.finestOn()) {
// 		boolean t1 = (sc != null);
// 		boolean t2 = (Class.forName("org.jocean.jdmk.Enumerated").isAssignableFrom(sc));
