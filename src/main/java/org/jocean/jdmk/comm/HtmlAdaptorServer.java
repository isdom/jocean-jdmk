 ...
 * <LI>using the {@link org.jocean.jdmk.comm.CommunicatorServer#setPort setPort} method before starting the adaptor
 * </UL>
 * The default object name is define by {@link org.jocean.jdmk.ServiceName#DOMAIN org.jocean.jdmk.ServiceName.DOMAIN} 
 * and {@link org.jocean.jdmk.ServiceName#HTML_ADAPTOR_SERVER org.jocean.jdmk.ServiceName.HTML_ADAPTOR_SERVER}.
 * <P>
 ...
 * <LI><CODE>org.jocean.jdmk.Enumerated</CODE>: Supported for readable attributes. As <CODE>org.jocean.jdmk.Enumerated</CODE> is an abstract class, 
...
public class HtmlAdaptorServer
     ...
     * <P>
     * The default port is defined in org.jocean.jdmk.ServiceName.HTML_ADAPTOR_PORT.
     */
    public HtmlAdaptorServer () {
        this(org.jocean.jdmk.ServiceName.HTML_ADAPTOR_PORT);
    }
     ...
     * {@link org.jocean.jdmk.comm.HtmlParser HtmlParser} and must already
	...
	boolean isParser = 
	    topMBS.isInstanceOf(parser,
				org.jocean.jdmk.comm.HtmlParser.class.getName());
	if (!isParser)
    ...
    public void createParser(String className, String parserName, 
        ...
        // Validate the parser.
        //
	if (!org.jocean.jdmk.comm.HtmlParser.class.isAssignableFrom(theParser.getClass())) {
	    theParser = null;
    ...
    public ObjectName preRegister(MBeanServer server, ObjectName name) 
        ...
        if (name == null) {
            name = new ObjectName(server.getDefaultDomain() +":"+ org.jocean.jdmk.ServiceName.HTML_ADAPTOR_SERVER);
        }
     ...
     * <P>
     * For a list of possible attributes look at the method {@link org.jocean.jdmk.comm.HtmlAdaptorServer#getAttribute getAttribute}.
     * 
     ...
     * <P>
     * For a list of possible attributes look at the method {@link org.jocean.jdmk.comm.HtmlAdaptorServer#setAttribute setAttribute}.
     *
    ...
    private void buildInfo() {
        ...
        dattributes[4]  = new MBeanAttributeInfo("HostIp","java.lang.String","HostIp: Hostname's Ip.",true,false,false);
        dattributes[5]  = new MBeanAttributeInfo("LastConnectedClient","java.lang.String","LastConnectedClient: The IP address of the last connected client.",true,false,false);
        dattributes[6]  = new MBeanAttributeInfo("MaxActiveClientCount","int","MaxActiveClientCount: The maximum number of clients the HtmlAdaptorServer can process concurrently.",true,true,false);
        dattributes[7]  = new MBeanAttributeInfo("Parser","javax.management.ObjectName","Parser: ObjectName of the MBean used to customized HTML pages generated by the HtmlAdaptorServer.",true,true,false);
        dattributes[8]  = new MBeanAttributeInfo("Port","int","Port: Port number used.",true,true,false);
        dattributes[9]  = new MBeanAttributeInfo("Protocol","java.lang.String","Protocol: html.",true,false,false);
        dattributes[10]  = new MBeanAttributeInfo("ServedClientCount","int","ServedClientCount: The number of clients that have been processed by the HtmlAdaptorServer since its creation.",true,false,false);
        dattributes[11] = new MBeanAttributeInfo("State","int","State: State of the HtmlAdaptorServer.",true,false,false);
        dattributes[12] = new MBeanAttributeInfo("StateString","java.lang.String","StateString: State of the HtmlAdaptorServer.",true,false,false);
        dattributes[13] = new MBeanAttributeInfo("LocalPort","int","LocalPort: Local Port assigned by OS.",true,false,false);

        Constructor[] ctor = this.getClass().getConstructors();
	for (int i = 0; i < ctor.length; i++) {
	    if (ctor[i].getParameterTypes().length == 0) {
		dconstructors[0] = new MBeanConstructorInfo("Instantiate HtmlAdaptorServer with default port number equal to " + org.jocean.jdmk.ServiceName.HTML_ADAPTOR_PORT + ".",ctor[i]);
    ...
    private MBeanAttributeInfo[] dattributes = new MBeanAttributeInfo[14];
