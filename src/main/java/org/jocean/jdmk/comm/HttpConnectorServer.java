 ...
 *
 * @see org.jocean.jdmk.comm.HttpConnectorClient
 *
 */
public class HttpConnectorServer extends GenericHttpConnectorServer implements HttpConnectorServerMBean {
    ...
    public HttpConnectorServer() {
        super(CommunicatorServer.HTTP_TYPE, org.jocean.jdmk.ServiceName.HTTP_CONNECTOR_PORT);
    }
     ...
     * {@link org.jocean.jdmk.ServiceName#HTTP_CONNECTOR_SERVER org.jocean.jdmk.ServiceName.HTTP_CONNECTOR_SERVER}.
    ...
    public ObjectName preRegister(MBeanServer server, ObjectName name) throws Exception {
        if (name == null) {
            name = new ObjectName(server.getDefaultDomain() + ":" + org.jocean.jdmk.ServiceName.HTTP_CONNECTOR_SERVER);
        }
