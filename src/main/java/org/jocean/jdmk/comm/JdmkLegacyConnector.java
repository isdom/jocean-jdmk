...
public interface JdmkLegacyConnector {
    ...
    /**
     * Specifies a list of AuthInfo (org.jocean.jdmk.comm.AuthInfo[]) for an
     * HTTP or HTTPS connector server.
     * <p>
     * The key value is the string "org.jocean.jdmk.http.server.authinfo.list".
     */
    public final static String HTTP_SERVER_AUTHINFO_LIST =
        "org.jocean.jdmk.http.server.authinfo.list";

    /**
     * Specifies the local InetAddress the HTTP/HTTPS connector server will
     * bind to.
     * <p>
     * The key value is the string "org.jocean.jdmk.http.server.local.address".
     */
    public final static String HTTP_SERVER_LOCAL_ADDRESS =
        "org.jocean.jdmk.http.server.local.address";
     ...
     * <p>
     * The key value is the string "org.jocean.jdmk.https.server.need.client.auth",
