...
/**
 * The <CODE>DiscoveryResponse</CODE> is used by the {@link org.jocean.jdmk.discovery.DiscoveryClient}
 * class to represent the result of a discovery operation.
 *
 * @see 	org.jocean.jdmk.discovery.DiscoveryClient
 */
...
// ----------------------------------------------------------
  ...
  /**
     ...
     * {@link org.jocean.jdmk.comm.ConnectorAddress} if its relevant.
